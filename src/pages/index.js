...
const DOMAIN = 'https://meta-og.vercel.app/'; // Replace with your domain
const title = 'BITMATIC ART TEST';
...
const ogImageUrl = `${DOMAIN}/api/og?title=${encodeURIComponent(title)}&description=${encodeURIComponent(description)}&imageUrl=${encodeURIComponent(imgUrl)}`;
